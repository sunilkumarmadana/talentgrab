        ...
        <?php //print_r($this->session->all_userdata());?>
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <form action="/signup/register_submit" method="post" accept-charset="utf-8" enctype="multipart/form-data" class="form-horizontal application" role="form" id="example-form">      
                        <div>
                            <h3>Personal Details</h3>
                            <section>
                                <p><font color="red"><font color="red" size="4px">*</font> Mandatory</font></p>
                                <label for="inputfirstName">First Name: <font color="red" size="4px">*</font></label>
                                    <input type="text" id="inputfirstName" name="inputfirstName" class="required form-control"/><br />
                                <label for="inputlastName">Last Name: <font color="red" size="4px">*</font></label>
                                ...
                                <label for="inputphoneNumberCode">Country of Residence: <font color="red" size="4px">*</font></label>
                                ...
                                <label for="inputphoneNumber">Phone Number: <font color="red" size="4px">*</font></label>
                                ...
                                <label for="inputGender" class="required">Gender: <font color="red" size="4px">*</font></label>
                                <label class="radio-inline">
                                    <input type="radio" name="inputGender" id="inlineRadio1" value="Male" class="required" /> Male
                                </label>
                                <label class="radio-inline required">
                                    <input type="radio" name="inputGender" id="inlineRadio2" value="Female" class="required" /> Female
                                </label><br /><br />                                
                                <label for="inputNationality">Nationality: <font color="red" size="4px">*</font></label>
                            ...
                            <section>
                                <p><font color="red"><font color="red" size="4px">*</font> Mandatory</font></p>
                                <label for="inputCurrentposition">Current position: <font color="red" size="4px">*</font></label>
                                    <input type="text" name="inputCurrentposition" class="form-control required" id="inputCurrentposition"/><br />
                                <label for="inputCurrentcompany">Current employer: <font color="red" size="4px">*</font></label>
                                    <input type="text" name="inputCurrentcompany" class="form-control required" id="inputCurrentcompany"/><br />
                                <label for="inputCompanylocation">Employer Location: <font color="red" size="4px">*</font></label>
                                ...
                                <label for="inputcurrentAnnualSal">Current / Last Monthly Salary</label>
                                <div class="row">
                                ...
                                <label for="inputexpAnnualSal">Expected Monthly Salary</label>
                                <div class="row">
                                    <div class="col-xs-3 col-md-2">
                                ...
                                <label for="inputExperience">Total years of relevant work experience*</label>
                                <input type="text" name="inputTotExperience" id="inputTotExperience" maxlength="2" class="form-control required"/><br />
                            </section>
                            <h3>Academic Details</h3>
                            <section>
                                <p><font color="red"><font color="red" size="4px">*</font> Mandatory</font></p>
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#eduLvlModal">Add Education</button><br /><br />
                                ...
                                <label for="inputbriefDesc">Brief Description:</label>
                                <textarea id="inputbriefDesc" name="inputbriefDesc" rows="7" class="form-control"></textarea><br />
                                <label>
                                    <input type="checkbox" id="inputjobalertagreement" name="inputjobalertagreement"/> I wish to receive Job alerts from GrabTalent.
                                </label><br /><br />
                                <label id="lblTermsagreement" data-toggle="tooltip" data-placement="top" title="Please choose this option">
                                    <input type="checkbox" id="termsagreement" name="termsagreement"/> I agree to GrabTalent <a href="#" target="_blank">Terms & Conditions / Privacy Policy.</a>
                                </label><br /><br />
                            </section>
                        </div>
                    </form>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="eduLvlModalLabel">Add Education Level</h4>
                        </div>
                        <div class="modal-body">
                            ...
                            <form method="post" accept-charset="utf-8" enctype="multipart/form-data" role="form" id="example-form">
                                <div class="form-group">
                                    <label for="inputSchool" class="control-label">School/University:</label>
                                    <input type="text" class="form-control" id="inputSchool" name="inputSchool" required/>
                                </div>
                                <div class="form-group">
                                    <label for="educationlvl" class="control-label">Education level:</label>
                                ...
                                <div class="form-group">
                                    <label for="message-text" class="control-label">Field of Study:</label>
                                    <input type="text" class="form-control" id="inputFieldofStudy" name="inputFieldofStudy" required/>
                                </div>
                                <label for="message-text" class="control-label">Education Start Date:</label>
                                <div class="form-group">                                    
                                ...
                                <label for="message-text" class="control-label">Education End Date:</label>
                                <div class="form-group">                                    
                                    <div class="col-xs-12 col-md-4">
